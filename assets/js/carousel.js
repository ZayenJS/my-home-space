...
class Carousel {
    constructor(element, options) {
        ...
        this.start = () => {
            ...
            const intervalCallback = this.options.direction === 'forward' ? this.nextImage : this.previousImage;
        ...
        this.loadImages = () => {
            ...
            imgElement.addEventListener('load', () => {
                carouselContentElement === null || carouselContentElement === void 0 ? void 0 : carouselContentElement.appendChild(imgElement);
         ...
         *
         */
        this.onMouseInteractionOnImage = (event) => {
         ...
         *
         */
        this.createIndicator = (isActive = false) => {
         ...
         *
         */
        this.indicatorElementClickHandler = (event) => {
            const indicatorElement = event.target;
            const currentImage = this.getActiveImage();
            const currentImageIndex = parseInt(currentImage.dataset.index, 10);
            const newImageIndex = parseInt(indicatorElement.dataset.index, 10);
         ...
         */
        this.getActiveImage = () => {
            return this.element.querySelector('.carousel__image.active');
        };
        /**
         *
        ...
        this.changeImage = (currentImageIndex, newImageIndex) => {
            ...
            const newImage = carouselImages[newImageIndex];
        ...
        this.activateControls = () => {
            const leftArrowElement = this.element.querySelector('#carousel__nav .left');
            const rightArrowElement = this.element.querySelector('#carousel__nav .right');
        ...
        this.nextImage = () => {
            ...
            if (nextImage) {
                ...
                const nextImageIndex = parseInt(nextImage.dataset.index, 10);
        ...
        this.previousImage = () => {
            ...
            if (previousImage) {
                ...
                const previousImageIndex = parseInt(previousImage.dataset.index, 10);
        ...
        this.loadImages();
        this.activateControls();
        this.options.direction = (_a = this.options.direction) !== null && _a !== void 0 ? _a : 'forward';
        this.options.duration = (_b = this.options.duration) !== null && _b !== void 0 ? _b : 5000;
        if (this.options.autoPlay) {
            this.start();
        }
    }
